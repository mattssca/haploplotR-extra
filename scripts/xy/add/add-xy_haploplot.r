  ...
  # read additional tracks
  addtrack.list = list.files(path = "in/add_tracks/", recursive = TRUE, pattern = "\\.bed$", full.names = TRUE)
  
  # set colour for additional track
  add.track.colour = "#ffc67c"
  
  # read variants into R
  addtrack = rbindlist(sapply(addtrack.list, fread, simplify = FALSE), use.names = TRUE)
  
  # update column names
  colnames(addtrack) <- c("chr", "start", "end", "geneID")
  
  # add columnf or vertical position on ideograms
  addtrack =  cbind(vertpos = 0, addtrack)
  addtrack =  cbind(horpos = 5, addtrack)
  ...
  addtrack = addtrack %>%
    ...
    mutate(middle = size/2) %>%
    mutate(coordinate = start + middle) %>%
    select(chr, vertpos, horpos, coordinate, geneID)
  
  # convert chr to factors
  addtrack$chr = as.factor(addtrack$chr)
  
  # check for na observation and replace with 0
  add.track.no.obs = data.frame(0, 0, 0, -1000000000, "NONE")
  names(add.track.no.obs) <- c("chr", "vertpos", "horpos", "coordinate", "geneID")  
  
  # subset on chr
  chr1.ideo.addtrack = filter(addtrack, chr == "chr1")
  chr2.ideo.addtrack = filter(addtrack, chr == "chr2")
  chr3.ideo.addtrack = filter(addtrack, chr == "chr3")
  chr4.ideo.addtrack = filter(addtrack, chr == "chr4")
  chr5.ideo.addtrack = filter(addtrack, chr == "chr5")
  chr6.ideo.addtrack = filter(addtrack, chr == "chr6")
  chr7.ideo.addtrack = filter(addtrack, chr == "chr7")
  chr8.ideo.addtrack = filter(addtrack, chr == "chr8")
  chr9.ideo.addtrack = filter(addtrack, chr == "chr9")
  chr10.ideo.addtrack = filter(addtrack, chr == "chr10")
  chr11.ideo.addtrack = filter(addtrack, chr == "chr11")
  chr12.ideo.addtrack = filter(addtrack, chr == "chr12")
  chr13.ideo.addtrack = filter(addtrack, chr == "chr13")
  chr14.ideo.addtrack = filter(addtrack, chr == "chr14")
  chr15.ideo.addtrack = filter(addtrack, chr == "chr15")
  chr16.ideo.addtrack = filter(addtrack, chr == "chr16")
  chr17.ideo.addtrack = filter(addtrack, chr == "chr17")
  chr18.ideo.addtrack = filter(addtrack, chr == "chr18")
  chr19.ideo.addtrack = filter(addtrack, chr == "chr19")
  chr20.ideo.addtrack = filter(addtrack, chr == "chr20")
  chr21.ideo.addtrack = filter(addtrack, chr == "chr21")
  chr22.ideo.addtrack = filter(addtrack, chr == "chr22")
  chrx.ideo.addtrack = filter(addtrack, chr == "chrX")
  chry.ideo.addtrack = filter(addtrack, chr == "chrY")
  
  if(nrow(chr1.ideo.addtrack) == 0){
    chr1.ideo.addtrack <- rbind(chr1.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr2.ideo.addtrack) == 0){
    chr2.ideo.addtrack <- rbind(chr2.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr3.ideo.addtrack) == 0){
    chr3.ideo.addtrack <- rbind(chr3.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr4.ideo.addtrack) == 0){
    chr4.ideo.addtrack <- rbind(chr4.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr5.ideo.addtrack) == 0){
    chr5.ideo.addtrack <- rbind(chr5.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr6.ideo.addtrack) == 0){
    chr6.ideo.addtrack <- rbind(chr6.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr7.ideo.addtrack) == 0){
    chr7.ideo.addtrack <- rbind(chr7.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr8.ideo.addtrack) == 0){
    chr8.ideo.addtrack <- rbind(chr8.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr9.ideo.addtrack) == 0){
    chr9.ideo.addtrack <- rbind(chr9.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr10.ideo.addtrack) == 0){
    chr10.ideo.addtrack <- rbind(chr10.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr11.ideo.addtrack) == 0){
    chr11.ideo.addtrack <- rbind(chr11.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr12.ideo.addtrack) == 0){
    chr12.ideo.addtrack <- rbind(chr12.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr13.ideo.addtrack) == 0){
    chr13.ideo.addtrack <- rbind(chr13.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr14.ideo.addtrack) == 0){
    chr14.ideo.addtrack <- rbind(chr14.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr15.ideo.addtrack) == 0){
    chr15.ideo.addtrack <- rbind(chr15.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr16.ideo.addtrack) == 0){
    chr16.ideo.addtrack <- rbind(chr16.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr17.ideo.addtrack) == 0){
    chr17.ideo.addtrack <- rbind(chr17.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr18.ideo.addtrack) == 0){
    chr18.ideo.addtrack <- rbind(chr18.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr19.ideo.addtrack) == 0){
    chr19.ideo.addtrack <- rbind(chr19.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr20.ideo.addtrack) == 0){
    chr20.ideo.addtrack <- rbind(chr20.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr21.ideo.addtrack) == 0){
    chr21.ideo.addtrack <- rbind(chr21.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chr22.ideo.addtrack) == 0){
    chr22.ideo.addtrack <- rbind(chr22.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chrx.ideo.addtrack) == 0){
    chrx.ideo.addtrack <- rbind(chrx.ideo.addtrack, add.track.no.obs) 
  }
  
  if(nrow(chry.ideo.addtrack) == 0){
    chry.ideo.addtrack <- rbind(chry.ideo.addtrack, add.track.no.obs) 
  }
  ...
  geom_segment(data = chr1.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr1.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
  ...
  geom_segment(data = chr2.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr2.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr3.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr3.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr4.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr4.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr5.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr5.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr6.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr6.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr7.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr7.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr8.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr8.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr9.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr9.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr10.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr10.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr11.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr11.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr12.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr12.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr13.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr13.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr14.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr14.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr15.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr15.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr16.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr16.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr17.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr17.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr18.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr18.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr19.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr19.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr20.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr20.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr21.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr21.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chr22.ideo.h2.het, aes(x = coordinate, xend = coordinate, y = 0, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chr22.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -2, yend = 2), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chrx.ideo, aes(x = coordinate, xend = coordinate, y = -1, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chrx.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -1, yend = 1), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
  ...
  geom_segment(data = chry.ideo, aes(x = coordinate, xend = coordinate, y = -1, yend = genotype), color = heterozygous.variants.color) + 
    ...
    # add track
    geom_segment(data = chry.ideo.addtrack, aes(x = coordinate, xend = coordinate, y = -1, yend = 1), color = add.track.colour, size = 1) +
    # annotate with number of inversion per haplotype
